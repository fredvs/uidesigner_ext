...
begin
  ...
  //  ACanvas.GradientFill(r, TfpgColor($fafafa), TfpgColor($e2e2e2), gdVertical);
    ...
    //ACanvas.GradientFill(r, TfpgColor($fafafa), cldarkseagreen, gdVertical);
     ...
     //  ACanvas.GradientFill(r22,  TfpgColor($fafafa),  TfpgColor($e2e2e2), gdVertical);
     //  ACanvas.GradientFill(r21,  TfpgColor($e2e2e2),  TfpgColor($fafafa), gdVertical);
...
initialization
  fpgStyleManager.RegisterClass('Chrome1', TMyStyle);
