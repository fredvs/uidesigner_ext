...
begin
  ...
  begin
    ...
    case style of
    -1 : Canvas.DrawButtonFace(r, []) ;
    0 : begin
       Canvas.SetColor(clsilver);
     ...
     1 :  begin
      canvas.GradientFill(r, cldarkgray, cllightgray, gdVertical);
    ...
    2 :  begin
      r21.SetRect(r.Left, r.Top, r.Width, r.Height div 2);
      r22.SetRect(r.Left, r.Top + (r.Height div 2), r.Width, r.Height div 2);
     canvas.GradientFill(r21, clgray, clwhite, gdVertical);
     Canvas.GradientFill(r22, clwhite, clgray, gdVertical);
      Canvas.SetColor(cldarkgray);
      Canvas.DrawRectangle(r);
      end;
  ...
  begin
    ...
    0 : begin
     ...
     1 :  begin
      canvas.GradientFill(r, clwhite, cldarkgray, gdVertical);
