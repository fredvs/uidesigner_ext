...
If uidesigner_ext does not load, even as stand-alone, it is surely because a other instance of uidesigner_ext is already running. If so, kill that instance via Ctrl-Alt-Delete.
