{ This is a patched version of main.pp for Lazarus version 1.2.2
...
//// fred was here for fpgui
 ...
 begin
     ...
     dataf := copy(GetAppConfigDir(false),1, pos(applicationname, GetAppConfigDir(false))-1) +
         'uidesigner_ext' + directoryseparator + 'uidesigner_ext.ini'  ;
